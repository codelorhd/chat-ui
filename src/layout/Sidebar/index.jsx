      ...
      <div className="flex h-[100vh] w-full min-h-0 flex-col ">
        <nav className={`${styles.nav} p-2 relative`}>
          ...
          <div className={`${styles.bottom} p-2 pt-4 bg-[#202123]`}>
            <a
              href="#0"
              className="w-full flex py-3 px-3 items-center gap-3 transition-colors duration-200 text-white cursor-pointer text-sm hover:bg-[#0a3764] rounded-md flex items-center"
            >
              <Icons.User />
                Settings
            </a>
